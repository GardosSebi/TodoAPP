...
export default function CompletedClient({ projects, tasks }: CompletedClientProps) {
  ...
  const handleTaskUpdate = async (taskId: string, updates: Partial<Task>) => {
    // Optimistic update handled by TaskItem
    try {
            ...
            >
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {projectTasks.length} {projectTasks.length === 1 ? 'sarcină finalizată' : 'sarcini finalizate'}
                </p>
              </div>
            </button>
      ...
      {tasksWithoutProject.length > 0 && (
        ...
        >
          <div className="p-4 bg-gray-50 dark:bg-gray-800">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {tasksWithoutProject.length} {tasksWithoutProject.length === 1 ? 'sarcină finalizată' : 'sarcini finalizate'}
            </p>
          </div>
          <div className="p-4 space-y-2 bg-white dark:bg-gray-800">
